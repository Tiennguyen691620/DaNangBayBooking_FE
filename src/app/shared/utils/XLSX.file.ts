...
import { CancelBookingReportExcel } from '../models/report/cancel-booking-report-filter.model';
...
export class XLSXFile {
  ...
  static reportBookingCancel(headers: any, data: any, excelFileName: string, filterModel: CancelBookingReportExcel): void {
    ...
    worksheet['D2'] = { t: 's', v: filterModel.accommodationId };
    ...
    worksheet['D3'] = { t: 's', v: filterModel.bookingFromDate };

    worksheet['F3'] = { t: 's', v: 'Đến ngày:', s: { font: { bold: true } } };
    worksheet['G3'] = { t: 's', v: filterModel.bookingToDate };

    worksheet['C4'] = { t: 's', v: 'Ngày nhận/trả phòng:', s: { font: { bold: true } } };
    worksheet['D4'] = { t: 's', v: filterModel.checkInFromDate };

    worksheet['F4'] = { t: 's', v: 'Đến ngày:', s: { font: { bold: true } } };
    worksheet['G4'] = { t: 's', v: filterModel.checkInToDate };
